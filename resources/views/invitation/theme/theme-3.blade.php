...
<head>
    ...
    <link href="{{ asset('theme/theme3/images/favicon.png')}}" rel="icon">
    <link href="{{ asset('theme/theme3/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href='https://fonts.googleapis.com/css?family=Lobster' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Roboto+Slab:400,300' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Dancing+Script:700' rel='stylesheet' type='text/css'>
    <link href="{{ asset('theme/theme3/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{ asset('theme/theme3/css/owl.carousel.css')}}" rel="stylesheet">
    <link href="{{ asset('theme/theme3/css/owl.theme.css')}}" rel="stylesheet">
    <link href="{{ asset('theme/theme3/css/nivo-lightbox.css')}}" rel="stylesheet">
    <link href="{{ asset('theme/theme3/css/nivo-default.css')}}" rel="stylesheet">
    <link href="{{ asset('theme/theme3/css/animate.min.css')}}" rel="stylesheet">
    <link href="{{ asset('theme/theme3/css/style.css')}}" rel="stylesheet">
    <link href="{{ asset('theme/theme3/css/responsive.css')}}" rel="stylesheet">
...
<body>
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="theme-logo hidden-xs">
                            <a href="/">
                                <img src="{{ asset('theme/theme3/images/logo.png')}}" alt="Logo" class="hidden-sm logo-rotating">
                                <img src="{{ asset('theme/theme3/images/logo-sm.png')}}" alt="Logo" class="hidden-md hidden-lg logo-rotating">
                                <div>
                                    <div>
                                        <span>{{$wedding->nicknameMale}}</span>
                                        <span>{{$wedding->nicknameFemale}}</span>
                                    </div>
                                </div>
                            </a>
                        </li>
    ...
    <section class="wedding-announcement section-padding" id="couple">
            ...
            <div class="row content">
                <div class="col col-sm-6 left-col">
                    <div class="col col-xs-6 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                        <div class="frame">
                            <img src="{{ asset('theme/theme3/images/home/announcement/img-frame.png')}}" alt="Frame" class="img img-responsive img-circle">
                            <img src="{{$wedding->photoMale}}" height="325px" width="338px" alt="Groom" class="img img-circle">
                        </div>
                        ...
                        <div class="mb-5 mt-0 p-0" id="family-profil-2" style="">
                            ...
                            <a href="{{$wedding->instagramMale}}" class="card-link text-secondary" style="font-size:14px">@ {{$wedding->instagramMale}}</a>
                            @endif
                        </div>
                    </div>
                </div>
                <div class="col col-sm-6 right-col">
                    <div class="col col-xs-6 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                        <div class="frame">
                            <img src="{{ asset('theme/theme3/images/home/announcement/img-frame.png')}}" alt="Frame" class="img img-responsive img-circle">
                            <img src="{{$wedding->photoFemale}}" height="325px" width="338px" alt="Bride" class="img img-circle">
                        </div>
                        ...
                        <div class="mb-5 mt-0 p-0" id="family-profil-1" style="">
                            ...
                            <i class="fa fa-instagram" aria-hidden="true"></i>
                            <a href="{{$wedding->instagramFemale}}" class="card-link text-secondary" style="font-size:14px">@ {{$wedding->instagramFemale}}</a>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col col-xs-12 col-md-10 col-md-offset-1 col-sm-12 col-lg-8 col-lg-offset-2">
                            ...
                            <div class="col col-xs-4 col-sm-4">
                                <div class="frame">
                                    <img src="{{ asset('theme/theme3/images/home/love-story/img-frame-right.png')}}" alt="Frame">
                        ...
                        <div class="col col-xs-12 col-md-10 col-md-offset-1 col-sm-12 col-lg-8 col-lg-offset-2 middle">
                            <div class="col col-xs-4 col-sm-4">
                                <div class="frame padding-left">
                                    <img src="{{ asset('theme/theme3/images/home/love-story/img-frame-left.png')}}" alt="Frame">
                    ...
                    <div class="row">
                        <div class="col col-xs-12 col-md-10 col-md-offset-1 col-sm-12 col-lg-8 col-lg-offset-2">
                            ...
                            <div class="col col-xs-4 col-sm-4">
                                <div class="frame">
                                    <img src="{{ asset('theme/theme3/images/home/love-story/img-frame-right.png')}}" alt="Frame">
                                    <img src="https://t4.ftcdn.net/jpg/01/05/25/81/360_F_105258122_xgYVLq1QPk8w7Izl35U3t9i4KYcDhvEU.jpg" alt="Love picture">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="video-bg">
        ...
        <div class="row">
            ...
            <a href="{{$wedding->ourstoryvideo}}" class="btn btn-default">
                <i class="fa fa-play"></i>
            </a>
            @endif
        </div>
    </section> <!-- end of video-bg -->
                ...
                <div class="row" id="first-row">
                    <div class="col col-md-4">
                        <div class="event-frame">
                            <img src="{{ asset('theme/theme3/images/home/event/frame.png')}}" alt="Event Frame" class="">
...
<!--
        ...
        <div class="container">
            ...
            <div class="row content">
                ...
                <div class="col col-sm-4">
                    <div class="frame">
                        <a href="#">
                            <img src="{{ asset('theme/theme3/images/home/journal/frame.png')}}" alt="Frame" class="frame-main">
                            <img src="{{ asset('theme/theme3/images/home/journal/frame-sm.png')}}" alt="Frame" class="frame-sm">
                            <img src="{{ asset('theme/theme3/images/home/journal/img-1.jpg')}}" alt="Journal" class="main-img">
                            <div class="hover-title">
                                <div>
                                    <span>Wedding Preparations</span>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="col col-sm-4">
                    <div class="frame">
                        <a href="#">
                            <img src="{{ asset('theme/theme3/images/home/journal/frame.png')}}" alt="Frame" class="frame-main">
                            <img src="{{ asset('theme/theme3/images/home/journal/frame-sm.png')}}" alt="Frame" class="frame-sm">
                            <img src="{{ asset('theme/theme3/images/home/journal/img-2.jpg')}}" alt="Journal" class="main-img">
                            <div class="hover-title">
                                <div>
                                    <span>Wedding Preparations</span>
                                </div>
                ...
                <div class="col col-sm-4">
                    <div class="frame">
                        <a href="#">
                            <img src="{{ asset('theme/theme3/images/home/journal/frame.png')}}" alt="Frame" class="frame-main">
                            <img src="{{ asset('theme/theme3/images/home/journal/frame-sm.png')}}" alt="Frame" class="frame-sm">
                            <img src="{{ asset('theme/theme3/images/home/journal/img-3.jpg')}}" alt="Journal" class="main-img">
                            <div class="hover-title">
                                <div>
                                    <span>Wedding Preparations</span>
                                </div>
    ...
    <section class="wedd-location section-padding">
        <div class="container">
            <div class="row section-heading">
                <div class="col col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
            ...
            <div class="row">
                <div class="col col-sm-4">
                    ...
                    <p>Audiam eripuit dolorem eos no, cu pro nostrud diceret. In mea appellantur reprehendunt.</p>
                </div>
                <div class="col col-sm-4">
                    <h3>Location</h3>
                    <div class="icon-frame">
...
-->
    ...
    <section class="map">
        <h2 class="hidden">Map</h2>
         <!-- google map <div id="googleMap-1"></div>  -->
    </section> <!-- end of map -->
    ...
    <script src="{{ asset('theme/theme3/js/jquery-1.11.3.min.js') }}"></script>
    <script src="{{ asset('theme/theme3/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('theme/theme3/js/jquery.appear.js') }}"></script>
    <script src="{{ asset('theme/theme3/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('theme/theme3/js/jquery.shuffle.min.js') }}"></script>
    <script src="{{ asset('theme/theme3/js/classie.js') }}"></script>
    <script src="{{ asset('theme/theme3/js/nivo-lightbox.min.js') }}"></script>
    <script src="{{ asset('theme/theme3/js/common-script.js') }}"></script>
    <script src="{{ asset('theme/theme3/js/index-script.js') }}"></script>
