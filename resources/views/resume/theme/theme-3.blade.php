		            ...
		            <div class="row align-items-center">
		                <div class="col-lg-6 col-12">
		                    <div class="banner-content">
								<h1>Hello...</h1>
								<h1>I'm <span>{{$resume->nickname}}</span> Grant A Professional</h1>
								<div class="dynamic-title cd-headline clip is-full-width">
									<h1 class="cd-words-wrapper" style="font-size: 30px">
										<b class="is-visible gold-title">{{$resume->job}}</b>
										<b class="gold-title">{{$resume->job}}</b>
		                ...
		                <div class="col-lg-6 col-12">
		                    <div class="banner-thumb">
		                        <img src="{{$resume->photo}}" alt="banner" class="img-fluid">
		                    </div>
		                </div>
		            </div>
	            </div>
				...
				<div class="bottom-wrapper section-wrapper">
					...
					<div class="post-item wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
						...
						<div class="post-content">
							...
							<h5><span>{{$resume->address}}</span></h5>
						</div>
					</div>
					@endif
				</div>
